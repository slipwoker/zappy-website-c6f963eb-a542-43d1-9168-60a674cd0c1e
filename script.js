document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorElement(field) {
    ...
    if (sibling && sibling.classList.contains('form-error-message')) return sibling;
    return null;
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "PaletteVibes משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'c6f963eb-a542-43d1-9168-60a674cd0c1e',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'c6f963eb-a542-43d1-9168-60a674cd0c1e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c6f963eb-a542-43d1-9168-60a674cd0c1e';
